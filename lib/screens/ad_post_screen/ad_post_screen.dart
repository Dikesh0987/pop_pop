...
class Ad_post_screen extends StatelessWidget {
  const Ad_post_screen({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(30)),
                    child: TextField(
                      decoration: _TextDecoration("Based on"),
                    ),
                  ),
                ),
                // Row(
                ...
                Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(30)),
                    child: TextField(
                      decoration: _TextDecoration("Discriptions"),
                    ),
                  ),
                ),
                SizedBox(
